    ...
    <div className="flex container flex-col justify-center items-start max-w-sm md:max-w-2xl lg:max-w-4xl mx-auto py-0 md:py-8">
      <div className="px-4 md:px-0 py-6 md:py-0 md:mt-12 w-full">
        ...
        <p className="text-gray-600 dark:text-gray-400 my-8">
          Are you trying to access some top secret content? Chances are you've
          misspelled something or found something that no longer exists. If
          you're just lost then press this handy button I left for you.
        </p>
        <Link href="/">
