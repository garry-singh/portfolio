...
const Home: NextPage = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-start max-w-4xl mx-auto py-0 md:py-8">
      <div className="px-4 md:px-0 py-6 md:py-0 md:mt-24">
        ...
        <main className="mt-6 pb-6 text-black dark:text-white">
          ...
          <p className="mb-4">
            ...
            things with code and also write the occasional blog post.
          </p>
        </main>
        <Subscribe />
      </div>
